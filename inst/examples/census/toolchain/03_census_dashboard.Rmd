...
pred <- read_csv("data/pred.csv")
m1 <- readRDS("data/logisticModel.rds")

pred <- arrange(pred, pred)
n <- nrow(pred)
```
...
Who are the people likely to make over \$50k? Profile individuals more or less likely to earn over \$50k in yearly income. Data are from the 1994-1995 population surveys conducted by the U.S. Census Bureau. [source](https://archive.ics.uci.edu/ml/datasets/Census+Income)
