...
#download.file("http://mlr.cs.umass.edu/ml/machine-learning-databases/adult/adult.data", "data/train_file.csv")
#download.file("http://mlr.cs.umass.edu/ml/machine-learning-databases/adult/adult.test", "data/test_file.csv")
```
...
train_raw <- read_csv("train_file.csv", col_names = col_names, na = "?")
test_raw  <- read_csv("test_file.csv", col_names = col_names, na = "?", skip = 1)
```
...
write_csv(pred.out, "data/pred_file.csv")
